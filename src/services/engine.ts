...
import type {Condition,Shipment,RulePack,Compilation,Result} from '../types';
...
export function selectPacks(packs:RulePack[],s:Shipment):RulePack[]{
 ...
 // Published demonstration fixtures remain in historical databases for auditability,
 // but must never participate in a live compilation. Only explicitly official packs
 // are executable in connected mode; new packs should use the OFFICIAL identifier.
